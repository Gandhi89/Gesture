    ...
    private void getAllActivePlayers() {
        ...
        /*mDatabaseReference.child("Users").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    Log.d("NearByPLayer/add11ar", playerName.toString());
                    Log.d("NearByPLayer/add11ar", ">>>>>>>>>>>>");
                    ...
                    Log.d("NearByPLayerarr/add11", playerName.toString());
                    Log.d("NearByPLayerarr/add11", playerEmail.toString());
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                //Log.d("NearByPLayer/updtar", playerName.toString());
                Log.d("NearByPLayer/updtar", dataSnapshot.toString());
                User user = dataSnapshot.getValue(User.class);
                String email = user.Email;
                String stat = user.Status;
                String name = user.userName;
