...
public class MainActivity extends AppCompatActivity implements ShakeDetector.Listener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv = findViewById(R.id.mainActivity_imageView);
        btn = findViewById(R.id.mainActivity_button);
